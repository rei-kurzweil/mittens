...
Editor.translation_space("world").rotation_space("local") {
    Raycastable.enabled() {
        ...
        Transform.position(0.0, -1.6565083265304565, -0.4000000059604645).rotation_quat(0.0, 0.0, 0.0, 1.0).scale(12.0, 0.18000000715255737, 9.5) {
            Renderable.cube() {
    ...
    Raycastable.enabled() {
        name = "editor_auto_raycastable"
        Transform.position(0.0, 2.1500000953674316, -7.199999809265137).rotation_quat(0.37874284386634827, 0.0, 0.0, 0.9255023002624512).scale(8.800000190734863, 3.5999999046325684, 0.23999999463558197) {
            Renderable.cube() {
    ...
    Raycastable.enabled() {
        ...
        Transform.position(2.0, 0.0, 1.0).rotation_quat(0.0, 0.0, 0.0, 1.0).scale(1.0, 1.0, 1.0) {
            Transform.position(-0.8999999761581421, 2.0178887844085693, -1.0).rotation_quat(0.0, 0.0, 0.0, 1.0).scale(0.5, 0.5, 0.5) {
                Renderable.cube() {
                    Color.rgba(1.0, 0.8799999952316284, 0.15000000596046448, 1.0)
                    Bounds.aabb([-0.5, -0.5, -0.5], [0.5, 0.5, 0.5])
                }
            }
            Transform.position(0.0, 2.2407114505767822, -0.699999988079071).rotation_quat(0.0, 0.0, 0.0, 1.0).scale(0.5, 0.5, 0.5) {
                Renderable.cube() {
                    Color.rgba(1.0, 0.3499999940395355, 0.7799999713897705, 1.0)
                    Bounds.aabb([-0.5, -0.5, -0.5], [0.5, 0.5, 0.5])
                }
            }
            Transform.position(0.8999999761581421, -0.4399999976158142, -1.100000023841858).rotation_quat(0.0, -0.3086092174053192, 0.0, 0.951188862323761).scale(0.5, 0.5, 0.5) {
                Renderable.cube() {
...
Input.speed(1.0) {
    ...
    Transform.position(6.988375663757324, 1.3904409408569336, 3.7428488731384277).rotation_quat(-0.1307179182767868, 0.14790187776088715, 0.019725432619452477, 0.9801268577575684).scale(1.0, 1.0, 1.0) {
