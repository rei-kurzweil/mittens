...
| 6 | [Non-tracked locomotion actions and vehicle behavior assets](../task/non-tracked-locomotion-actions-and-vehicle-behaviors.md) | Design proposal | Evaluate a one-module car behavior experiment before choosing separate desktop/XR assets; later converge on a normalized `Vec2` action surface |
