...
MusicContext {
    ...
    voice("synth-bass", "[name='synth-bass']")
    ...
    Animation.looping() {
        ...
        Keyframe.at(1.50) { MusicNote.e(3, 0.25, "lead") }
        // Keyframe.at(1.75) { MusicNote.d(2, 0.25, "lead") }
        
        Keyframe.at(2.0) {  MusicNote.a(2, 0.9, "synth-bass") }
        Keyframe.at(2.10) { MusicNote.a(1, 0.9, "synth-bass") }

        Keyframe.at(3.0) {  MusicNote.a(2, 0.9, "synth-bass") }
        Keyframe.at(3.10) { MusicNote.a(1, 0.9, "synth-bass") }

        Keyframe.at(4.0) {  
            MusicNote.a(2, 0.9, "synth-bass") 
            MusicNote.c(2, 2.0, "amen-break")
        }
        Keyframe.at(4.10) { MusicNote.a(1, 0.9, "synth-bass") }

        Keyframe.at(5.0) {  MusicNote.a(2, 0.9, "synth-bass") }
        Keyframe.at(5.10) { MusicNote.a(1, 0.9, "synth-bass") }

        Keyframe.at(6.0) {  MusicNote.a(2, 0.9, "synth-bass") }
        Keyframe.at(6.10) { MusicNote.a(1, 0.9, "synth-bass") }
