// toon-outline-bisket — XR Bisket outline smoke test, based on mittens-corp.
//
// Run with:
//   cargo run --release -- load examples/toon-outline-bisket.mms

// The outline is authored once beneath the GLTF component. GLTFSystem projects
// it onto every imported renderable while the renderer keeps one visual instance
// and one mesh/deformation allocation for the outline and foreground draws.
