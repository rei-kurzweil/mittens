...
impl ComponentCodec {
    ...
    fn create_component(
        ...
        match type_name {
            ...
            "renderer_stats" => Ok(Box::new(RendererStatsComponent::new())),
            ...
            "style" => Ok(Box::new(StyleComponent::new())),
            "html_element" => Ok(Box::new(HtmlElementComponent::new(ElementType::Element))),
            ...
            "texture_filtering" => Ok(Box::new(TextureFilteringComponent::nearest())),
            "transparent_cutout" => Ok(Box::new(TransparentCutoutComponent::default())),
